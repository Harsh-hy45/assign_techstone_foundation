...
import 'package:assign_techstone_foundation/components/new_bulb.dart';
  ...
  Widget build(BuildContext context) {
    return SlideTransition(
      ...
      child: ListView(
        ...
        children: [
          HorizontalMenuButton(
            icon: SvgPicture.asset("assets/img/surface1.svg", height: 25),
            position: "Main Light",
            isSelected: false,
          ),
          HorizontalMenuButton(
            icon: SvgPicture.asset("assets/img/furniture-and-household.svg", height: 25),
            position: "Desk Light",
            isSelected: true,
          ),
          HorizontalMenuButton(
            icon: SvgPicture.asset("assets/img/bed (1).svg", height: 25),
            position: "Bed Light",
            isSelected: false,
          ),
        ],
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: CircleAvatar(
            child: SvgPicture.asset("assets/img/Icon awesome-power-off.svg"),
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: [
              ...
              CircularAddButton(colors: Colors.white, path: "assets/img/+.svg")
            ],
          ),
        )
      ],
