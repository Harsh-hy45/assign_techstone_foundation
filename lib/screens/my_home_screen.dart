...
import 'package:assign_techstone_foundation/screens/my_bedroom_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:assign_techstone_foundation/components/new_objects.dart';
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              icon: SvgPicture.asset("assets/img/bulb.svg"),
              label: '',
            ),
            BottomNavigationBarItem(
              icon: SvgPicture.asset("assets/img/Icon feather-home.svg"),
              label: '',
            ),
            BottomNavigationBarItem(
              icon: SvgPicture.asset("assets/img/Icon feather-settings.svg"),
              label: '',
            ),
          ],
        ),
